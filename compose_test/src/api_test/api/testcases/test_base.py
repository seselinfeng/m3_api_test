...
from api_test.api.pages.login import Login
from api_test.api.pages.room_status import Room_Status
from api_test.api.pages.stock import Stock
from api_test.api.utils.tools import GetRequestParas
